...
export default function LoginUbsPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLocalErro(null);
    try {
      // O backend usa a propriedade "cpf" de forma genérica para autenticação,
      // então enviamos o CNPJ apenas com números.
      const u = await entrar(cnpj.replace(/\D/g, ""), senha);
